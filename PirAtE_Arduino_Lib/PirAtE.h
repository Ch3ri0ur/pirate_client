...
#define PirAtE_DELIMITER_LENGTH 8
byte PirAtE_DELIMITER[PirAtE_DELIMITER_LENGTH] = {0xff, 'P', 'i', 'r', 'A', 't', 'E', '\n'};
...
#define PirAtE_DATATYPE_LENGTH 1

//Int,Long (Unsigned,Signed)
#define PirAtE_DATATYPE_INT 'I'
#define PirAtE_DATATYPE_INT_LENGTH sizeof(int)
#define PirAtE_DATATYPE_UINT 'U'
#define PirAtE_DATATYPE_UINT_LENGTH sizeof(unsigned int)
#define PirAtE_DATATYPE_LONG 'L'
#define PirAtE_DATATYPE_LONG_LENGTH sizeof(long)
#define PirAtE_DATATYPE_ULONG 'u'
#define PirAtE_DATATYPE_ULONG_LENGTH sizeof(unsigned long)

//Float,Double
#define PirAtE_DATATYPE_FLOAT 'F'
#define PirAtE_DATATYPE_FLOAT_LENGTH sizeof(float)
#define PirAtE_DATATYPE_DOUBLE 'D'
#define PirAtE_DATATYPE_DOUBLE_LENGTH sizeof(double)

//Byte
#define PirAtE_DATATYPE_BYTE 'B'
#define PirAtE_DATATYPE_BYTE_LENGTH sizeof(byte)
//Word
#define PirAtE_DATATYPE_WORD 'W'
#define PirAtE_DATATYPE_WORD_LENGTH sizeof(word)

//Bool '0' or '1'
#define PirAtE_DATATYPE_BOOL 'b'
#define PirAtE_DATATYPE_BOOL_LENGTH sizeof(bool)
//Char 1 Length
#define PirAtE_DATATYPE_CHAR 'C'
#define PirAtE_DATATYPE_CHAR_LENGTH sizeof(char)
//String,CharArray
#define PirAtE_DATATYPE_STRING 'S'
#define PirAtE_DATATYPE_STRING_MAXLENGTH (PirAtE_MSG_DATA_MAXLENGTH - PirAtE_CHARARRAY_END_LENGTH)
...
#define PirAtE_MSG_DATA_OVERHEAD (PirAtE_MSG_DATAID_LENGTH + PirAtE_DATATYPE_LENGTH)
//MaxData Length
#define PirAtE_MSG_DATA_MAXLENGTH (PirAtE_Serial_Buffer_Size - PirAtE_MSG_DATA_OVERHEAD - PirAtE_DELIMITER_LENGTH)
...
//todo Serial buffer size übertragen
  ...
  #define PirAtE_START() PirAtE_ComType_Serialfunc.begin(PirAtE_Serial_Baudrate);
#else
  #define PirAtE_START()                                                                      \
    {                                                                                             \
      ...
      PirAtE_SEND_DATATYPEINFO(PirAtE_DATATYPE_INT, PirAtE_DATATYPE_INT_LENGTH);          \
      PirAtE_SEND_DATATYPEINFO(PirAtE_DATATYPE_UINT, PirAtE_DATATYPE_UINT_LENGTH);        \
      PirAtE_SEND_DATATYPEINFO(PirAtE_DATATYPE_LONG, PirAtE_DATATYPE_LONG_LENGTH);        \
      PirAtE_SEND_DATATYPEINFO(PirAtE_DATATYPE_ULONG, PirAtE_DATATYPE_ULONG_LENGTH);      \
      PirAtE_SEND_DATATYPEINFO(PirAtE_DATATYPE_FLOAT, PirAtE_DATATYPE_FLOAT_LENGTH);      \
      PirAtE_SEND_DATATYPEINFO(PirAtE_DATATYPE_DOUBLE, PirAtE_DATATYPE_DOUBLE_LENGTH);    \
      PirAtE_SEND_DATATYPEINFO(PirAtE_DATATYPE_BYTE, PirAtE_DATATYPE_BYTE_LENGTH);        \
      PirAtE_SEND_DATATYPEINFO(PirAtE_DATATYPE_WORD, PirAtE_DATATYPE_WORD_LENGTH);        \
      PirAtE_SEND_DATATYPEINFO(PirAtE_DATATYPE_BOOL, PirAtE_DATATYPE_BOOL_LENGTH);        \
      PirAtE_SEND_DATATYPEINFO(PirAtE_DATATYPE_CHAR, PirAtE_DATATYPE_CHAR_LENGTH);        \
      PirAtE_SEND_DATATYPEINFO(PirAtE_DATATYPE_STRING, PirAtE_DATATYPE_STRING_MAXLENGTH); \
      PirAtE_ComType_Serialfunc.write(PirAtE_DELIMITER, PirAtE_DELIMITER_LENGTH);         \
      delay(1000);                                                                                \
    }
...
#ifdef PirAtE_COM_OFF
 #define PirAtE_SET_SEND_FLAG(PirAtE_MSG_KEY) {}
 #define PirAtE_ADD_SEND_VAR(...) 0;
 #define PirAtE_ADD_SEND_STRING(...) 0;
 #define PirAtE_SEND() {}
#else 
  #ifndef PirAtE_SendVar_Amount
  #define PirAtE_SendVar_Amount 5
  #endif
  byte *PirAtE_DATA_SEND_ADDRESSES[PirAtE_SendVar_Amount];
  byte PirAtE_DATA_SEND_DATASIZE[PirAtE_SendVar_Amount];
  byte PirAtE_DATA_SEND_DATATYPE_MASK[PirAtE_SendVar_Amount];
  byte PirAtE_DATA_SEND_SENDMODE_MASK[PirAtE_SendVar_Amount / 8 + (PirAtE_SendVar_Amount % 8 ? 1 : 0)];
  byte PirAtE_DATA_SEND_NEWDATA_AVAILABLE_MASK[PirAtE_SendVar_Amount / 8 + (PirAtE_SendVar_Amount % 8 ? 1 : 0)];
  ...
  #define PirAtE_ADD_SEND_VAR(...) PirAtE_GET_SENDMSG_MACRO(__VA_ARGS__,PirAtE_ADD_SEND_VAR5, PirAtE_ADD_SEND_VAR4, PirAtE_ADD_SEND_VAR3, , )(__VA_ARGS__)
  
  #define PirAtE_ADD_SEND_VAR3(Data_Name, Global_VariableAddress, PirAtE_MSG_DATATYPE)                                               \
    PirAtE_ADD_SEND_VAR5(Data_Name, Global_VariableAddress, PirAtE_MSG_DATATYPE, PirAte_DEFAULT_SCALE_NAME, PirAtE_MSG_SENDMODE_AUTO) 
  
  #define PirAtE_ADD_SEND_VAR4(Data_Name, Global_VariableAddress, PirAtE_MSG_DATATYPE, PirAtE_Scale)                     \
    PirAtE_ADD_SEND_VAR5(Data_Name, Global_VariableAddress, PirAtE_MSG_DATATYPE, PirAtE_Scale, PirAtE_MSG_SENDMODE_AUTO) 
  
  #define PirAtE_ADD_SEND_VAR5(Data_Name, Global_VariableAddress, PirAtE_MSG_DATATYPE, PirAtE_Scale, PirAtE_MSG_SENDMODE)  \
  ...
  {
    if (PirAtE_MSG_ID >= PirAtE_SendVar_Amount)
    {
      PirAtE_DEBUG("ERROR: PirAtE_SendVar_Amount is already reached")
    }
  ...
  #define PirAtE_SET_SENDMSG(PirAtE_MSG_ID, Global_VariableAddress, PirAtE_MSG_DATATYPE, PirAtE_MSG_SENDMODE) \
    {                                                                                                         \
      ...
      {                                                                                                       \
      case PirAtE_DATATYPE_INT:                                                                           \
        PirAtE_DATA_SEND_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_INT;                              \
        PirAtE_DATA_SEND_DATASIZE[PirAtE_MSG_ID] = PirAtE_DATATYPE_INT_LENGTH;                            \
        break;                                                                                                \
      case PirAtE_DATATYPE_UINT:                                                                          \
        PirAtE_DATA_SEND_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_UINT;                             \
        PirAtE_DATA_SEND_DATASIZE[PirAtE_MSG_ID] = PirAtE_DATATYPE_UINT_LENGTH;                           \
        break;                                                                                                \
      case PirAtE_DATATYPE_LONG:                                                                          \
        PirAtE_DATA_SEND_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_LONG;                             \
        PirAtE_DATA_SEND_DATASIZE[PirAtE_MSG_ID] = PirAtE_DATATYPE_LONG_LENGTH;                           \
        break;                                                                                                \
      case PirAtE_DATATYPE_ULONG:                                                                         \
        PirAtE_DATA_SEND_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_ULONG;                            \
        PirAtE_DATA_SEND_DATASIZE[PirAtE_MSG_ID] = PirAtE_DATATYPE_ULONG_LENGTH;                          \
        break;                                                                                                \
      case PirAtE_DATATYPE_FLOAT:                                                                         \
        PirAtE_DATA_SEND_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_FLOAT;                            \
        PirAtE_DATA_SEND_DATASIZE[PirAtE_MSG_ID] = PirAtE_DATATYPE_FLOAT_LENGTH;                          \
        break;                                                                                                \
      case PirAtE_DATATYPE_DOUBLE:                                                                        \
        PirAtE_DATA_SEND_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_DOUBLE;                           \
        PirAtE_DATA_SEND_DATASIZE[PirAtE_MSG_ID] = PirAtE_DATATYPE_DOUBLE_LENGTH;                         \
        break;                                                                                                \
      case PirAtE_DATATYPE_BYTE:                                                                          \
        PirAtE_DATA_SEND_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_BYTE;                             \
        PirAtE_DATA_SEND_DATASIZE[PirAtE_MSG_ID] = PirAtE_DATATYPE_BYTE_LENGTH;                           \
        break;                                                                                                \
      case PirAtE_DATATYPE_WORD:                                                                          \
        PirAtE_DATA_SEND_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_WORD;                             \
        PirAtE_DATA_SEND_DATASIZE[PirAtE_MSG_ID] = PirAtE_DATATYPE_WORD_LENGTH;                           \
        break;                                                                                                \
      case PirAtE_DATATYPE_BOOL:                                                                          \
        PirAtE_DATA_SEND_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_BOOL;                             \
        PirAtE_DATA_SEND_DATASIZE[PirAtE_MSG_ID] = PirAtE_DATATYPE_BOOL_LENGTH;                           \
        break;                                                                                                \
      case PirAtE_DATATYPE_CHAR:                                                                          \
        PirAtE_DATA_SEND_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_CHAR;                             \
        PirAtE_DATA_SEND_DATASIZE[PirAtE_MSG_ID] = PirAtE_DATATYPE_CHAR_LENGTH;                           \
        break;                                                                                                \
      case PirAtE_DATATYPE_STRING:                                                                        \
        PirAtE_DATA_SEND_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_STRING;                           \
        PirAtE_DATA_SEND_DATASIZE[PirAtE_MSG_ID] = PirAtE_DATATYPE_STRING_MAXLENGTH;                      \
        break;                                                                                                \
      }                                                                                                       \
    }
  ...
  #define PirAtE_ADD_SEND_STRING(...) PirAtE_GET_STRING_SENDMSG_MACRO(__VA_ARGS__,PirAtE_ADD_SEND_STRING4, PirAtE_ADD_SEND_STRING3, PirAtE_ADD_SEND_STRING2, )(__VA_ARGS__)
  
  #define PirAtE_ADD_SEND_STRING2(Data_Name, Global_VariableAddress)                                                           \
    PirAtE_ADD_SEND_STRING4(Data_Name, Global_VariableAddress, PirAtE_MSG_SENDMODE_AUTO, PirAtE_DATATYPE_STRING_MAXLENGTH) 
    
  #define PirAtE_ADD_SEND_STRING3(Data_Name, Global_VariableAddress, PirAtE_MSG_SENDMODE)                                \
    PirAtE_ADD_SEND_STRING4(Data_Name, Global_VariableAddress, PirAtE_MSG_SENDMODE, PirAtE_DATATYPE_STRING_MAXLENGTH) 
  
  #define PirAtE_ADD_SEND_STRING4(Data_Name, Global_VariableAddress, PirAtE_MSG_SENDMODE, StringBufferLength)         \
    PirAtE_DEFINED_SEND_MSGS;                                                                                                \
    {                                                                                                                        \
      PirAtE_SET_SENDMSG(PirAtE_DEFINED_SEND_MSGS, Global_VariableAddress, PirAtE_DATATYPE_STRING, PirAtE_MSG_SENDMODE); \
      if (StringBufferLength - PirAtE_CHARARRAY_END_LENGTH > PirAtE_DATATYPE_STRING_MAXLENGTH)                           \
      {                                                                                                                      \
        PirAtE_DEBUG("ERROR: SendString exceeds PirAtE_DATATYPE_STRING_MAXLENGTH");                           \
        PirAtE_DATA_SEND_DATASIZE[PirAtE_DEFINED_SEND_MSGS] = PirAtE_DATATYPE_STRING_MAXLENGTH;                          \
      }                                                                                                                      \
      else                                                                                                                   \
      {                                                                                                                      \
        PirAtE_DATA_SEND_DATASIZE[PirAtE_DEFINED_SEND_MSGS] = StringBufferLength - PirAtE_CHARARRAY_END_LENGTH;              \
      }                                                                                                                      \
      PirAtE_SEND_SENDMSG_INFO(PirAtE_DEFINED_SEND_MSGS, Data_Name, PirAtE_DATATYPE_STRING, PirAte_DEFAULT_SCALE_NAME);  \
      PirAtE_DEFINED_SEND_MSGS++;                                                                                            \
    }
      ...
      {                                                                                                                                                                        \
        ...
        {                                                                                                                                                                      \
          ...
          {                                                                                                                                                                    \
            if(tmpMsgSize == 0)                                                                                                                                                \
            {                                                                                                                                                                  \
              if (PirAtE_DATA_SEND_DATATYPE_MASK[PirAtE_SEND_MSG_Index] == PirAtE_DATATYPE_STRING)                                                                         \
              {                                                                                                                                                                \
            ...
            if (PirAtE_ComType_Serialfunc.availableForWrite() >= PirAtE_DELIMITER_LENGTH + PirAtE_MSG_DATA_OVERHEAD + tmpMsgSize)                                          \
            {                                                                                                                                                                  \
...
//TODO Name Change to Control Variable
#ifdef PirAtE_COM_OFF
  #define PirAtE_ADD_RECV_VAR(Data_Name, Global_VariableAddress, PirAtE_MSG_DATATYPE, Default_Value, Max_Value, Min_Value) 0;
  #define PirAtE_ADD_RECV_STRING(Data_Name, Global_VariableAddress, StringBufferLength) 0;
  #ifndef PirAtE_IS_NEW_DATA_AVAILABLE_Default_Flag_Value
  #define PirAtE_IS_NEW_DATA_AVAILABLE_Default_Flag_Value 0
  #endif
  #define PirAtE_GET_RECV_FLAG(PirAtE_MSG_KEY) PirAtE_IS_NEW_DATA_AVAILABLE_Default_Flag_Value
  #define PirAtE_RST_RECV_FLAG(PirAtE_MSG_KEY) {}
  #define PirAtE_RECV() {}
#else
  
  #ifndef PirAtE_RecvVar_Amount
  #define PirAtE_RecvVar_Amount 5
  #endif
  
  byte *PirAtE_DATA_RECEIVE_ADDRESSES[PirAtE_RecvVar_Amount];
  byte PirAtE_DATA_RECEIVE_DATASIZE[PirAtE_RecvVar_Amount];
  byte PirAtE_DATA_RECEIVE_DATATYPE_MASK[PirAtE_RecvVar_Amount];
  byte PirAtE_DATA_RECEIVE_NEWDATA_AVAILABLE_MASK[PirAtE_RecvVar_Amount / 8 + (PirAtE_RecvVar_Amount % 8 ? 1 : 0)];
  int PirAtE_DEFINED_RECEIVE_MSGS = 0;
  
  #define PirAtE_ADD_RECV_VAR(Data_Name, Global_VariableAddress, PirAtE_MSG_DATATYPE, Default_Value, Max_Value, Min_Value) \
  ...
  {
    if (PirAtE_MSG_ID >= PirAtE_RecvVar_Amount)
    {
      PirAtE_DEBUG("ERROR: PirAtE_RecvVar_Amount is already reached");
    }
  ...
  #define PirAtE_SET_RECEIVEMSG(PirAtE_MSG_ID, Global_VariableAddress, PirAtE_MSG_DATATYPE)     \
    {                                                                                           \
      ...
      {                                                                                         \
      case PirAtE_DATATYPE_INT:                                                             \
        PirAtE_DATA_RECEIVE_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_INT;             \
        PirAtE_DATA_RECEIVE_DATASIZE[PirAtE_MSG_ID] = PirAtE_DATATYPE_INT_LENGTH;           \
        break;                                                                                  \
      case PirAtE_DATATYPE_UINT:                                                            \
        PirAtE_DATA_RECEIVE_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_UINT;            \
        PirAtE_DATA_RECEIVE_DATASIZE[PirAtE_MSG_ID] = PirAtE_DATATYPE_UINT_LENGTH;          \
        break;                                                                                  \
      case PirAtE_DATATYPE_LONG:                                                            \
        PirAtE_DATA_RECEIVE_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_LONG;            \
        PirAtE_DATA_RECEIVE_DATASIZE[PirAtE_MSG_ID] = PirAtE_DATATYPE_LONG_LENGTH;          \
        break;                                                                                  \
      case PirAtE_DATATYPE_ULONG:                                                           \
        PirAtE_DATA_RECEIVE_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_ULONG;           \
        PirAtE_DATA_RECEIVE_DATASIZE[PirAtE_MSG_ID] = PirAtE_DATATYPE_ULONG_LENGTH;         \
        break;                                                                                  \
      case PirAtE_DATATYPE_FLOAT:                                                           \
        PirAtE_DATA_RECEIVE_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_FLOAT;           \
        PirAtE_DATA_RECEIVE_DATASIZE[PirAtE_MSG_ID] = PirAtE_DATATYPE_FLOAT_LENGTH;         \
        break;                                                                                  \
      case PirAtE_DATATYPE_DOUBLE:                                                          \
        PirAtE_DATA_RECEIVE_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_DOUBLE;          \
        PirAtE_DATA_RECEIVE_DATASIZE[PirAtE_MSG_ID] = PirAtE_DATATYPE_DOUBLE_LENGTH;        \
        break;                                                                                  \
      case PirAtE_DATATYPE_BYTE:                                                            \
        PirAtE_DATA_RECEIVE_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_BYTE;            \
        PirAtE_DATA_RECEIVE_DATASIZE[PirAtE_MSG_ID] = PirAtE_DATATYPE_BYTE_LENGTH;          \
        break;                                                                                  \
      case PirAtE_DATATYPE_WORD:                                                            \
        PirAtE_DATA_RECEIVE_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_WORD;            \
        PirAtE_DATA_RECEIVE_DATASIZE[PirAtE_MSG_ID] = PirAtE_DATATYPE_WORD_LENGTH;          \
        break;                                                                                  \
      case PirAtE_DATATYPE_BOOL:                                                            \
        PirAtE_DATA_RECEIVE_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_BOOL;            \
        PirAtE_DATA_RECEIVE_DATASIZE[PirAtE_MSG_ID] = PirAtE_DATATYPE_BOOL_LENGTH;          \
        break;                                                                                  \
      case PirAtE_DATATYPE_CHAR:                                                            \
        PirAtE_DATA_RECEIVE_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_CHAR;            \
        PirAtE_DATA_RECEIVE_DATASIZE[PirAtE_MSG_ID] = PirAtE_DATATYPE_CHAR_LENGTH;          \
        break;                                                                                  \
      case PirAtE_DATATYPE_STRING:                                                          \
        PirAtE_DATA_RECEIVE_DATATYPE_MASK[PirAtE_MSG_ID] = PirAtE_DATATYPE_STRING;          \
  ...
  #define PirAtE_ADD_RECV_STRING(Data_Name, Global_VariableAddress, StringBufferLength)                     \
    PirAtE_DEFINED_RECEIVE_MSGS;                                                                                      \
    {                                                                                                                 \
      PirAtE_SET_RECEIVEMSG(PirAtE_DEFINED_RECEIVE_MSGS, Global_VariableAddress, PirAtE_DATATYPE_STRING)          \
      if (StringBufferLength - PirAtE_CHARARRAY_END_LENGTH > PirAtE_RECEIVE_DATATYPE_STRING_MAXLENGTH)                \
      {                                                                                                               \
        PirAtE_DEBUG("ERROR: ReceiveString exceeds PirAtE_RECEIVE_DATATYPE_STRING_MAXLENGTH");             \
      ...
      PirAtE_SEND_RECEIVEMSG_INFO(PirAtE_DEFINED_RECEIVE_MSGS, Data_Name, PirAtE_DATATYPE_STRING);                \
      PirAtE_ComType_Serialfunc.write(PirAtE_TRANSMIT_SEPERATOR);                                                     \
  ...
  #define PirAtE_GET_RECV_FLAG(PirAtE_MSG_KEY) \
    ...
    {                                                                                                                                                       \
      ...
      {                                                                                                                                                     \
        ...
        {                                                                                                                                                   \
          ...
          {                                                                                                                                                 \
            if (PirAtE_DATA_RECEIVE_DATATYPE_MASK[msgID] == PirAtE_DATATYPE_STRING)                                                                     \
            {                                                                                                                                               \
              PirAtE_ComType_Serialfunc.read();                                                                                                             \
      ...
      {                                                                                                                                                     \
        ...
        {                                                                                                                                                   \
          if (PirAtE_ComType_Serialfunc.availableForWrite() > PirAtE_DELIMITER_LENGTH + PirAtE_REQUEST_DATA_LENGTH)                                     \
          {                                                                                                                                                 \
