...
#define PirAtE_AllowedReceiveBlockTime_micros 20000ul
...
*/
/*
PirAtE_DEFINE_SENDMSG_MAKRO(PirAtE_MSG_ID,PirAtE_MSG_DATATYPE, Global_VariableAdress, PirAtE_MSG_SENDMODE)
*/
...
*/
/*
PirAtE_DEFINE_RECEIVEMSG_MAKRO(PirAtE_MSG_ID,PirAtE_MSG_DATATYPE, Global_VariableAdress)
*/
/*
